...
\subsubsection{Availability and Integrity (Architecture Security)}
\begin{figure}[t]
	\centering
...
\subsubsection{Secrecy, Authenticity, and Key Agreement (Cryptographic Security)}\label{sec:encryption}
