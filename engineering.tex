...
\begin{definition}{\bf Infosec-Confidentiality --}\label{def:infosec-c}
	An Information $\varphi$ is considered to be confidential over a set of
	...
	\begin{itemize}
		\item[$(\interpretation21)$]
			for all agents $a\in Ag$, $\world\models\information{a}{\varphi}$ and
			$\world\models\rcc(\varphi,Conf) \wedge \neg\dr{Conf}{\varphi}$ iff
			$\world\models\knows{x}{[\information{a'}{\varphi}\rightarrow\varphi]}$
			for any agent $a'$ such that $a'\not\in Ag_c$
	\end{itemize}
\end{definition}
