...
As depicted in Figure~\ref{fig:causality}, in order to define a theory on cybersecurity we may
...
distinguish between a secure and an insecure system. 
...
\fix{mr}{To be reviewed by Marco}
\begin{table*}[t]
\centering
...
We now map MAS to CPS and show how this mapping allows us
