...
%\end{figure}
%As an illustrative example, in Fig.~\ref{fig:protocol-example}, under the
...
\begin{figure}[t]
	\centering
	\includegraphics[width=.35\columnwidth]{causality.pdf}
	\caption{Etiology of cybersecurity}
	\label{fig:causality}
\end{figure}

As depicted in Fig.~\ref{fig:causality}, in order to define a theory on cybersecurity we may
...
In the quantitative evaluation of a single agent, depicted in Fig.~\ref{fig:quantitative},
...
\begin{figure}[t]
	\centering
	\includegraphics[width=.8\columnwidth]{quantitative.pdf}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=.5\columnwidth]{soundness.pdf}
...
between two agents.  Therefore, as depicted in
Fig.~\ref{fig:system-agent}, an agent has two main categories of assertions,
...
\begin{figure}[t]
	\centering
	\includegraphics[width=.7\columnwidth]{abftheory.pdf}
	\caption{Mapping Epistemological Concepts to (Cyber-Physical) Systems Engineering}
	\label{fig:mashyp}
\end{figure}

As depicted in Fig.~\ref{fig:mashyp}, we relate MAS and CPS as follows.
\begin{itemize}
...
an equality can be considered as generating a weaknesses.
...
Tab.~\ref{tab:weaknesses}. Functionality-related weaknesses can be seen as a
...
\begin{table*}[t]
\centering
	\begin{tabular}{c C{.3\textwidth} C{.55\textwidth}} 
	...
	PO & Selectively drops inputs and inserts new data & Byzantine behavior. Occasionally outputs the expected output given the correct inputs. Not all inputs are handled properly, nor all the expected outputs are always generated when correct inputs are given
\end{tabular}
...
\begin{figure}
	\centering
	\includegraphics[width=.6\columnwidth]{v-secra.pdf}
	\caption{Cybersecurity Risk Assessment Tool}
	\label{fig:secra}
\end{figure}
As depicted in Fig.~\ref{fig:secra}, the cybersecurity risk assessment process
...
The results, summarized in Fig.~\ref{fig:results}, reports 16777216
