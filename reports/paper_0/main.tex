...
An input port is, in the $\abftheory$-framework, defined secure as long as the relation
	...
	%every open region\fixnote{Oliviero}{First time we refer to open regions; perhaps briefly introduce them?} can be written as union of elements of that base.
