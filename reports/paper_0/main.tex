...
\begin{abstract}
	...
	insecure and secure configurations of any abstract system.  Our
...
no cybersecurity flaw), and assuming that no violation to any cybersecurity property
...
on the focus and findings of the verification of the cybersecurity of the protocol.
...
be considered as semantically equivalent (cybersecurity is confidentiality and vice-versa).
...
cybersecurity attacks, and we assume that achieving cybersecurity means preventing all those attacks 
