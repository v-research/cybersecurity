...
\fixnote{mv}{In Fig. 5 e 6, i simboli A, B e F hanno un font diverso dal solito}
\begin{figure}[t]
	\centering
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item[SE-$1.2$] Similarly, the equality relation
			...
			architecture.
	\end{enumerate}
\item[SE-$2$]\fixnote{mv}{Are agents missing in the notation A,B,F for SE-2 and SE-3?}
	Sufficient Control Flow Management  is defined as
		$\eq{\assertionRegion}{\factRegion}$.
	\item[SE-$3$] Correct Calculation  is defined as
		$\eq{\beliefRegion}{\factRegion}$.
\end{enumerate}
...
a function of the likelihood and the impact of all potential attacks).
...
\begin{definition}{\bf Risk Matrix --}
	...
	(RCC5 in our case).
\end{definition}
While a risk matrix is often defined as a function of 
