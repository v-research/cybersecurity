...
masking is implemented is believed to be secure because an intruder won't be
...
\fix{mr}{add description of our approach and theory}
...
\subsection{Multi-Agent Systems}\label{sec:system}
...
considered as a network of interacting elements. \fixnote{mv}{il ragionamento dell'intro, in particolare il "Therefore", non mi convince del tutto; dalla definizione mi verrebbe da pensare un sistema come un insieme di agenti che interagiscono piuttosto che come un agente singolo}
%single agent where its interacting elements are the
%constituents of the agent itself. 
