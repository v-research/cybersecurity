...
\addbibresource{../../97-literature/literature.bib}% Syntax for version >= 1.2
...
\begin{definition}{\bf Region: Weakness and Vulnerability --}\label{def:weakness}
	When a Region $\region\subseteq\agent$ of an agent
	$\agent\in\agentuniverse$ is identified as Weakness $\Weakness$ (i.e.
