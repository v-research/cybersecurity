...
in Figure~\ref{fig:security-safety}, we lack the concept of intent and
...
As we mentioned in Section~\ref{sec:problem_statement} when we postulated the
...
priori. Therefore, as we mentioned in Section~\ref{sec:problem_statement}, the
...
considering the malicious intent of an agent necessarily results in a security
scientific theory.  On the other hand, the complete definition of Errors,
predicted by a (sound w.r.t. Errors) security theory seems to be a proper
research direction.  In other words, system \emph{in-security} and
